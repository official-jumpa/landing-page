...
export default function WithdrawOptions({ isOpen, onClose }: WithdrawOptionsProps) {
    ...
    return (
        ...
        >
            ...
            <div
                className={`
                    relative w-full max-w-md bg-white rounded-3xl p-6 pb-10 shadow-2xl 
                ...
                <div className="flex flex-col items-center text-center">
                    ...
                    <div className="w-full space-y-3">
                        ...
                        <button
                            ...
                            className="w-full h-14 bg-[#F3F4F6] active:bg-gray-200 transition-colors py-4 px-5 flex items-center justify-between rounded-xl border-none outline-none font-sans"
                        >
